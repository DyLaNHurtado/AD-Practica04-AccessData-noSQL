...
//        transactionManager.commit();
    ...
    private void departamentoJSON() {
        ...
        System.out.println(departamentoController.getDepartamentoById("1e89386d-be37-4930-b6ae-bcba6c9917b4"));

        System.out.println("POST Insertando Departamento");
        DepartamentoDTO departamentoDTO = DepartamentoDTO.builder()
                .id(Long.parseLong(ObjectId.get().toString()))
        ...
        departamentoDTO = DepartamentoDTO.builder()
                .id("512a0695-3294-4c2c-86d9-4babd4485fa8")
    ...
    private void programadorJSON() {
        ...
        System.out.println(programadorController.getProgramadorById("d63f0d73-3f1b-4afd-b5d0-821449daa4a3"));
        ...
        programadorDTO = ProgramadorDTO.builder()
                .id("53269670-1586-49ac-9df5-62ddd55f96cc")
                .nombre("Prueba2")
                .fechaAlta(LocalDate.now())
                //Cuidado que es tipo Date
                .departamento(new Departamento("2d1d1422-fede-4e27-8883-3ffdb1be1a7c"))
        ...
        programadorDTO = ProgramadorDTO.builder()
                .id("d63f0d73-3f1b-4afd-b5d0-821449daa4a3")
                .fechaAlta(LocalDate.now())
                .build();
    ...
    private void proyectoJSON() {
        ...
        System.out.println(proyectoController.getProyectoById("81ee1211-760c-493d-968a-380e6af67363"));
        ...
        proyectoDTO = ProyectoDTO.builder()
                .id("81ee1211-760c-493d-968a-380e6af67363")
                .nombre("Prueba")
                .presupuesto(100.0)
                .fechaInicio(LocalDate.of(2015, 2, 13))
                .fechaFin(LocalDate.now())
